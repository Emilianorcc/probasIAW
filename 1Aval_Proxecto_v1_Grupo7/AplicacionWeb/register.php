            ...
            <div class = "register">    
                <form action = "/action_page.php">
                    <fieldset>
                        ...
                        <label for = "nombrereg">Nombre de usuario</label></br>
                        <input type = "text" id = "nombrereg" name = "nombrereg" value = "Sectario"></br></br>
                        <label for = "emailreg">Email</label></br>
                        <input type = "text" id = "emailreg" name = "emailreg" value = "Cultista@gmail.com"></br></br>
